...
|-------|--------|-----------|
| **Does plan file exist?** | `Read .agent/plans/{task-slug}.md` | STOP → Create plan first |
...
|------------|--------------|----------------|
| **Plan file exists** | `Read .agent/plans/{task-slug}.md` | Use project-planner first |
