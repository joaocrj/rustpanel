...
**UI Approach (Default: shadcn/ui):**
- ✅ **shadcn/ui** is the project default (per AI_RULES.md)
- ✅ Tailwind CSS is the styling base
- ❌ Only use other libraries if user explicitly requests

**When to ask about UI approach:**
- User mentions a specific library/approach
- User explicitly asks about UI options
- Project context suggests a different approach is needed
...
> 🔴 **Use shadcn/ui by default as specified in AI_RULES.md.**
